 ...
 // Changing the color of table (sun) 
 function alt_gray()
 {
 ...
 // Changing the color of table (moon)
 function alt_black()
 {
     var tableElements = document.getElementsByTagName("table") ;
 ...
 function sortTable(n) {
     ...
     // Start from 1 because we dont want to switch the headers
     for (i = 1; i < (rows.length - 1); i++) {
         //start by saying there should be no switching:
         shouldSwitch = false;
         
         // Selecting the row and row+1
