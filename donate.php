...
<body style = "background-color:#161625">
    ...
    <div class="razorpay-embed-btn" data-url="https://pages.razorpay.com/pl_HTdVa4xUbT2YRW/view" data-text="Donate" data-color="#528FF0" data-size="large" style="margin-left: 45%;">
        <script>
          (function(){
